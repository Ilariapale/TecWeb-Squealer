...
export const professional_type_row = (user) => `
  ...
  <select id="professionalType-${user._id}" class="form-select" aria-label="Default select example">
...
export const professional_status = (user) => {
  if (user.professional_type == "VIP") {
    return ` 
    <div class="row">
      <div class="col-6 py-2">${smm_row(user.smm)}</div>
    ...
    <div class="row"> 
      ...
      <div class="vr p-0"></div>
      <div class="col py-2">${managed_accounts_accordion(user?.managed_accounts)}</div>
...
export const owned_channels_accordion = (owned_channels) => {
  if (owned_channels && owned_channels.length == 0) {
    ...
    return `<div class="accordion accordion-flush" id="accordionFlushChannels">
            <div class="accordion-item">
...
export const editor_channels_accordion = (editor_channels) => {
  if (editor_channels && editor_channels.length == 0) {
    ...
    return `<div class="accordion accordion-flush" id="accordionFlushEditor">
            <div class="accordion-item">
